...
// export const watchVirtualMachineSummarys = (setVirtualMachineSummarys: React.Dispatch<React.SetStateAction<VirtualMachineSummary[] | undefined>>, setLoading: React.Dispatch<React.SetStateAction<boolean>>, abortCtrl: AbortController, opts?: WatchOptions): Promise<void> => {
//     return new Promise((resolve, reject) => {
//         setLoading(true)
