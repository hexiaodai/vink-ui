...
import { batchDeleteIPPools, fetchIPPools } from '@/resource-manager/ippool'
    ...
    return (
        <ProTable<CustomResourceDefinition, Params>
                    ...
                    <Space size={16}>
                        <a className={commonStyles["warning-color"]} onClick={async () => {
                            Modal.confirm({
                                ...
                                onOk: async () => {
                                    await batchDeleteIPPools(selectedRows, notification).then(() => {
            ...
            request={async (params) => {
                ...
                await fetchIPPools(setIPPools, advancedParams, notification)
                return { success: true }
            }}
            columnsState={{
