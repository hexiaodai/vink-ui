...
import Toolbar from '@/pages/virtual/image/list/toolbar'
import TableColumnAction from '@/pages/virtual/image/list/table-column-action'
import TableColumnStatus from '@/pages/virtual/image/list/table-column-status'
...
import TableColumnCapacity from '@/pages/virtual/image/list/table-column-capacity'
